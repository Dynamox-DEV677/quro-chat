...
import { initErrorHandler } from './error-handler.js?v=49';
import { sb, EMOJIS } from './config.js?v=49';
import * as State from './state.js?v=49';
import { escH, getMsgKey, showLoading, isMobile, setAvatarEl, stk_fmtIN, applyUserBarDecor, getDecorCls, notify } from './utils.js?v=49';
import { authErr, authOk, clearAuth, doRegister, doLogin, loadAndEnterApp, initApp, doLogout } from './auth.js?v=49';
import { openDrawer, closeDrawer, syncDrawer, handleSidebarToggle, updateSidebarToggleIcon, goHome, mobileNavTo, syncMobileNav, navigateBack, navPush, navPop, navClear, navStackPushRaw, getActiveOverlay, setActiveOverlay } from './navigation.js?v=49';
import { loadServersIntoBar, openServerBrowser, closeServerBrowser, srvBrowserOverlayClick, loadAllServers, joinServer, createServer, pickServer, pickServerById, addServer, checkServerOwnership, openServerSettings, closeServerSettings, saveServerSettings, uploadServerIcon, copyInviteLink, leaveServer, checkInviteLink, showInviteModal, closeInviteModal } from './servers.js?v=49';
import { loadServerChannels, openChannel, addChannel, closeAddChModal, selChType, confirmAddChannel, joinVoiceChannel, leaveVoiceChannel } from './channels.js?v=49';
import { _stopPoll, subscribeAndRender, fetchAndRenderMessages, appendMessage, fetchMyMsgCount, sendMsg, inputKey, growInput, renderMsgContent, _plainText, searchMsgs, openSearch, closeSearch, scrollToMsg } from './messaging.js?v=49';
import { fetchDMLastMessages, buildDMList, openDM, startNewDM, openUserSearch, closeUserSearch, userSearchOverlayClick, searchUsers, renderUSResults, selectUserForDM } from './dm.js?v=49';
import { loadGroupChats, renderGCList, openGroupChat, openGCCreate, closeGCCreate, gcSearchMembers, gcToggleUser, gcRemoveUser, gcUpdateTags, createGroupChat, openGCSettings, closeGCSettings, gcsRenderMembers, gcsSaveName, gcsUploadIcon, gcsClearIcon, gcsRemoveMember } from './groupchat.js?v=49';
import { fetchUsers, updatePresence, buildMembers, toggleMembers, mobileToggleMembers, openMobileMembers, closeMobileMembers } from './members.js?v=49';
import { startCall, endCall, _cleanupCall, _setupCallUI } from './calls.js?v=49';
import { _gcCleanup } from './calls-gc.js?v=49';
import { _subscribeCallSignals, acceptIncoming, declineIncoming } from './calls-incoming.js?v=49';
import { toggleMute, toggleCallVideo, toggleSpeaker, toggleScreenShare, stopScreenShare, minimizeCall, reopenCall } from './calls-controls.js?v=49';
import { openSettings, closeSettings, spNavTo, spShowNav, toggleDarkMode, changePassword, toggleNotifSound, toggleNotifDesktop, requestNotifPermission } from './settings.js?v=49';
import { saveNameplate, saveAbout, buildBannerGrid, saveBanner, getBannerStyle, uploadBannerImage, openProfilePopup, closeProfilePopup, syncFontPicker, pickFont, saveNameFont, buildColorGrid, syncColorPicker, pickColor, saveNameColor, buildDecorGrid, selectDecor, saveDecor, pickProfilePic, applyProfilePic, saveContactEmail, unlinkEmail, syncEmailSection, shareProfile, downloadShareCard, nativeShareCard } from './profile.js?v=49';
import { playNotifSound, showDesktopNotif, updateServerBadge, clearServerUnread, clearDMUnread, clearGCUnread, subscribeGlobalMessages } from './notifications.js?v=49';
import { _clearTypingChannel, _setupTypingChannel, _renderTyping, _onInputTyping } from './typing.js?v=49';
import { setReply, clearReply, editMsg, deleteMsg, showReactPicker, closeReactPicker, doReact, renderMsgReactions } from './reactions.js?v=49';
import { openEmoji, closeEmoji, emojiOverlayClick, insertEmoji } from './emoji.js?v=49';
import { handleFileUpload } from './file-upload.js?v=49';
import { initDragDrop } from './drag-drop.js?v=49';
import { openFriendsPage, closeFriendsPage, fpSwitchTab, fpRender, fpOpenDM } from './friends.js?v=49';
import { openLeaderPage, closeLeaderPage, loadLeaderboard, lpSwitchPeriod } from './leaderboard.js?v=49';
import { openStocksPanel, closeStocksPanel, stk_showDetail, closeStkDetail, changeStkRange, changeStkInterval, stkFilter, stkToggleSearch, stkSearchFilter, mobileOpenStocks, stk_startLiveRefresh } from './stocks.js?v=49';
import { openTradingPage, closeTradingPage, openTradeFromChat, openTradeFromStocks, trd_execute, trd_select, trd_setTab, trd_setMax, trd_setQty, trd_showBottom, trd_filterWatch, trd_updateOrder, trd_resetPortfolio, closeTrdConfirm, confirmTrdExec } from './trading.js?v=49';
import { initSplash } from './splash.js?v=49';
import { startAuthBubbles, stopAuthBubbles } from './auth-bubbles.js?v=49';
import { qConfirm, qPrompt, qAlert } from './modal.js?v=49';
import { isAdmin, initAdmin, hideAdmin, adminSearchUsers, adminKickUser, adminUnbanUser, verifyAdminPasscode, adminGrantAccess, adminRevokeAccess, checkBanned, showBannedScreen } from './admin.js?v=49';
...
Object.assign(window, {
  ...
  shareProfile, downloadShareCard, nativeShareCard,
  // Notifications
  notify,
  // Typing
  _onInputTyping,
