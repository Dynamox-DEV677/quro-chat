...
// 9s — Stocks list panel screenshot in phone frame
export const StocksListView: React.FC = () => {
    ...
    <AbsoluteFill style={{ opacity: exitOp }}>
      <AbsoluteFill style={{ justifyContent: 'flex-start', alignItems: 'center', paddingTop: 80, zIndex: 10 }}>
        <div style={{
          ...
          50 NSE Stocks. <span style={{ color: '#3da87a' }}>Live.</span>
        </div>
      </AbsoluteFill>
      ...
      <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'center', paddingTop: 120 }}>
        <div style={{
          ...
          <Img src={staticFile('stocks-list.png')} style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'top center' }} />
        </div>
      </AbsoluteFill>
